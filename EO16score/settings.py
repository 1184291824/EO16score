"""
Django settings for EO16score project.
...
SECRET_KEY = 'y4il--atntx^*un(yzwqq3+r9sog5$kqrsqn@a$kxgiyx9-%^+'
...
WSGI_APPLICATION = 'EO16score.wsgi.application'
